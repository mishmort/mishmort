...
const Globe = ({reloadtimer}) => {

    const [timer1, setTimer1] = useState(reloadtimer.current ? 15 : 0)
    ...
    return ( <div 
        className={timer1 >= 10 ? "stat statani outerglobe" : "stat outerglobe"}
    >
        <div 
            className="innerglobe globe"
            style={globestyle}
        >
...
const Knowledge = ({reloadtimer}) => {

    const [timer2, setTimer2] = useState(reloadtimer.current ? 15 : 0)
    ...
    return ( <div 
        className={timer2 >= 10 ? "stat statani" : "stat"}
    >

        <div 
            className="innerknowledge"
...
const Canvas = ({reloadtimer}) => {
    const [isDrawing, setIsDrawing] = useState(false)
    const canvasref = useRef(null)
    const [mousePosition, setMousePosition] = useState(undefined)
    const [timer3, setTimer3] = useState(reloadtimer.current ? 15 : 0)
    ...
    const Placeholder = () => {
        return ( <div className={timer3 >= 6 ? "statafter" : "phwrap"}>
            <div className="ph phx">

            </div>
            <div className="ph phy">
...
const Spinny = ({reloadtimer}) => {

    const [timer4, setTimer4] = useState(reloadtimer.current ? 15 : 0)
    ...
    return ( <div 
        className={timer4 >= 10 ? "stat statani" : "stat"}
    >
        <div 
            className="innerspinny"
            style={spinnystyle}
        >
...
const Mish = ({reloadtimer}) => {
    const [timer5, setTimer5] = useState(reloadtimer.current ? 15 : 0)
    ...
    return ( <div 
        className={timer5 >= 10 ? "stat statani outermish" : "stat outermish"}
    >
        <div 
            className="innermish"
            style={mishstyle}
        >
            ...
            <div className="eyewrap">
                <div className="eye leye" style={{transition: "transform 0.1s", transform: "translateY("+y+"px) translateX("+x+"px)"}}ref={leye}></div>
                <div className="eye reye" style={{transition: "transform 0.1s", transform: "translateY("+y+"px) translateX("+x+"px)"}} ref={reye}></div>
            </div>
...
const Game = ({reloadtimer}) => {

    const rnd = (min, max) => {
        return Math.floor(Math.random() * (max - min + 1) + min);
    }

    const [timer6, setTimer6] = useState(reloadtimer.current ? 15 : 0)
    ...
    return ( <div 
        className={timer6 >= 10 ? "stat statani outergame" : "stat outergame"}
    >
...
const SpinText = ({reloadtimer}) => {
    const [timer7, setTimer7] = useState(reloadtimer.current ? 15 : 0)
    ...
    return ( <div 
        className={timer7 >= 10 ? "stat statani outerspintext" : "stat outerspintext"}
    >
        <div 
            className="innerspintext"
            style={spintextstyle}
        >
...
/* ｡･:*:･ﾟ★💕｡･:*:･ﾟ☆✨｡･:*:･ﾟ★💕｡･:*:･ﾟ☆✨｡･:*:･ﾟ★💕｡･:*:･ﾟ☆✨｡･:*:･ﾟ★💕｡･:*:･ﾟ☆✨｡･:*:･ﾟ★💕｡･:*:･ﾟ☆✨｡･:*:･ﾟ★💕｡･:*:･ﾟ☆✨ */
// GRAPH
const Graph = ({reloadtimer}) => {
    const [timer8, setTimer8] = useState(reloadtimer.current ? 15 : 0)
    ...
    return ( <div 
        className={timer8 >= 10 ? "stat statani" : "stat"}
    >
        <div 
            className="innergraph"
            style={graphstyle}
        >
            <svg className="out" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 373.74 244.34"><defs></defs><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><polygon class="cls-1" points="163.32 23.09 55.32 81.09 1.42 174.64 125.32 230.09 218.32 214.09 287.32 243.09 372.5 114.79 277.32 1.09 163.32 23.09"/></g></g></svg>
            <svg className="mid" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 199.31 160.14"><defs></defs><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><polygon class="cls-1" points="12.52 33.08 1.02 103.59 12.52 159.07 179.52 144.08 198.19 46.66 119.52 1.08 12.52 33.08"/></g></g></svg>
            <svg className="inn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 144.56 85.08"><defs></defs><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><polygon class="cls-1" points="32.48 8.04 123.48 1.04 143.48 24.04 134.48 68.04 67.48 84.04 1.48 61.04 32.48 8.04"/></g></g></svg>
        </div>
...
const Pins = ({reloadtimer}) => {
    const [timer9, setTimer9] = useState(reloadtimer.current ? 15 : 0)
    ...
    return ( <div 
        className={timer9 >= 10 ? "stat statani" : "stat"}
    >
        <div 
            className="innerpins"
            style={pinsstyle}
